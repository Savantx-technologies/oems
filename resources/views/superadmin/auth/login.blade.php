...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-xl bg-white rounded-xl shadow-2xl p-7 sm:p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-center text-gray-800">Super Admin Login</h2>
        ...
        <div id="panel-password" class="mt-6">
            <form method="POST" action="{{ route('superadmin.login.submit') }}" class="space-y-4">
                ...
                <div class="text-center text-sm text-gray-500">
                    Prefer OTP? Click <button type="button" class="text-blue-600 font-semibold hover:underline" onclick="showPanel('otp')">OTP</button>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        function sendMobileOtp() {
            ...
            fetch('/superadmin/send-mobile-otp', {
                method: 'POST',
                headers: {
                ...
                .then(({ ok, data }) => {
                    showLoader(false);
                    if (data.status || (data.is_active !== undefined && data.is_active)) {
        ...
        function verifyMobileOtp() {
            ...
            fetch('/superadmin/verify-mobile-otp', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-Requested-With': 'XMLHttpRequest',
