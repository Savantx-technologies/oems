...
@section('content')
<div class="max-w-6xl mx-auto" x-data="{ passwordModalOpen: {{ $errors->any() ? 'true' : 'false' }} }">
    <div class="mb-8">
    ...
    <div x-show="passwordModalOpen"
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div x-show="passwordModalOpen"
                ...
                <form action="{{ route('superadmin.password.update') }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')

                    <div class="mb-4">
                        <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Change Password</h3>
                        <p class="text-sm text-gray-500 mt-1">Use a strong password that is different from your previous one.</p>
                    </div>
