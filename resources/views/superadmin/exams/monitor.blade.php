            ...
            <template x-for="student in students" :key="student.id">
                <div x-data="studentCard(student.id)"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="font-bold text-gray-800 text-lg truncate w-48 flex items-center gap-2">
                                    ...
                                    <i class="bi bi-mic-fill" :class="audioActive ? 'text-green-600' : 'text-gray-400'"title="Microphone"></i>
                                </div>
                    ...
                    <div class="grid grid-cols-4 gap-4 mt-auto">
                        ...
                        <button @click="listenToStudent()" :class="Alpine.store('monitor').selectedAudioStudent === studentId 
