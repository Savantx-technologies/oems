...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 to-purple-700 px-4">
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-2xl p-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-2 text-center">Verify Email OTP</h2>
        <p class="text-center text-sm text-gray-500 mb-6">
            {{ session('admin_otp_email') ? 'OTP sent to ' . session('admin_otp_email') : 'Enter the OTP sent to your registered email.' }}
        </p>
    ...
    <script>
        ...
        const otpEmail = "{{ session('admin_otp_email') ?? '' }}";
