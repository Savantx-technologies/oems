...
8,Science,What is photosynthesis?,2,Process in plants,Animal breathing,Water cycle,Soil erosion,A
                    ...
                    <p class="mt-2 text-xs text-gray-500">
                        <strong>Note:</strong> <span class="text-red-600 font-semibold">correct_option</span> must be
                        one of: <span class="font-mono">A</span>, <span class="font-mono">B</span>, <span
                            class="font-mono">C</span>, or <span class="font-mono">D</span>.
                    </p>
                </div>
