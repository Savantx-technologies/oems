...
<head>
    <meta charset="utf-8">
    <title>Super Admin Login OTP</title>
</head>
                ...
                <tr>
                    <td style="padding:24px;color:#333333;">
                        ...
                        <p style="margin:0 0 18px 0;font-size:14px;line-height:1.6;">
                            Use the following One-Time Password (OTP) to log in to your Super Admin account.
                        </p>
                ...
                <tr>
                    <td style="background:#f9fafb;padding:14px 24px;text-align:center;">
                        <p style="margin:0;font-size:12px;color:#888;">
                            © {{ date('Y') }} Exam-Portal – Secure Super Admin Access
                        </p>
                    </td>
                </tr>
